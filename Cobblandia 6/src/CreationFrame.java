...
public class CreationFrame extends JFrame{
	...
	public CreationFrame(FrameStack frameStack) {
		...
		this.background.setIcon(new ImageIcon("C:\\Users\\jackr\\Documents\\GitHub\\cobblandia\\Cobblandia 6\\src\\LabelImages\\CreationFrameImages\\creationFrameBackground.png"));
		...
		this.continueButton.setIcon(new ImageIcon("C:\\Users\\jackr\\Documents\\GitHub\\cobblandia\\Cobblandia 6\\src\\LabelImages\\CreationFrameImages\\continue.png"));
	...
	public JButton buttonCreator(JPanel panel, int typeOfButton, ListenForButton lForButton, int xLocation, int yLocation) {
		...
		if (typeOfButton == 1) {
			button.setIcon(new ImageIcon("C:\\Users\\jackr\\Documents\\GitHub\\cobblandia\\Cobblandia 6\\src\\LabelImages\\CreationFrameImages\\p1Image.png"));
		}
		else if (typeOfButton == 5) {
			button.setIcon(new ImageIcon("C:\\Users\\jackr\\Documents\\GitHub\\cobblandia\\Cobblandia 6\\src\\LabelImages\\CreationFrameImages\\p5Image.png"));
		}
		else if (typeOfButton == -1) {
			button.setIcon(new ImageIcon("C:\\Users\\jackr\\Documents\\GitHub\\cobblandia\\Cobblandia 6\\src\\LabelImages\\CreationFrameImages\\m1Image.png"));
		}
		else {
			button.setIcon(new ImageIcon("C:\\Users\\jackr\\Documents\\GitHub\\cobblandia\\Cobblandia 6\\src\\LabelImages\\CreationFrameImages\\m5Image.png"));
		}
